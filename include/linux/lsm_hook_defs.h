...
LSM_HOOK(int, 0, file_splice_pipe_to_pipe, struct file *in, struct file *out)
LSM_HOOK(int, 0, mq_timedsend, struct inode *inode, struct msg_msg *msg,
		struct timespec64 *ts)
LSM_HOOK(int, 0, mq_timedreceive, struct inode *inode, struct msg_msg *msg,
		struct timespec64 *ts)
LSM_HOOK(void, LSM_RET_VOID, shm_shmdt, struct kern_ipc_perm *shp)
LSM_HOOK(int, 0, socket_sendmsg_always, struct socket *sock, struct msghdr *msg,
		int size)
LSM_HOOK(int, 0, socket_recvmsg_always, struct socket *sock, struct msghdr *msg,
		int size, int flags)
